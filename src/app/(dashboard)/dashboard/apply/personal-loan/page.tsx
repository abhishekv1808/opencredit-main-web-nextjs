...
export default function ApplyPersonalLoanPage() {
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="font-display text-2xl lg:text-3xl font-bold text-heading">
          Personal Loan Application
        </h1>
        <p className="text-[11px] lg:text-sm text-text-muted mt-1">
          Complete all 5 steps. Your progress is auto-saved.
        </p>
        <div className="mt-3 bg-amber-50 border border-amber-200 rounded-xl p-3 text-[10px] lg:text-xs text-amber-800">
