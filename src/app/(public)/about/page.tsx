    ...
    <>
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 hero-bg-light overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <p className="text-brand-green text-xs lg:text-sm font-semibold uppercase tracking-wider mb-3">
            Our Story
          </p>
          <h1 className="font-display text-3xl md:text-5xl lg:text-6xl font-extrabold text-heading mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-green/10 rounded-full px-4 py-2 mb-6">
                <span className="text-[10px] lg:text-xs font-semibold text-brand-green uppercase tracking-wide">
                  Our Mission
                </span>
              </div>
              <h2 className="font-display text-2xl md:text-4xl font-extrabold text-heading mb-6">
                Democratizing Access to{" "}
                <span className="text-accent-gradient">Fair Credit</span>
              </h2>
              <div className="space-y-4 text-sm lg:text-base text-gray-500 leading-relaxed">
                <p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                >
                  <p className="font-display text-2xl lg:text-3xl font-extrabold text-brand-green mb-2">
                    {stat.number}
                  </p>
      ...
      <section className="section-padding bg-gray-50/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="font-display text-2xl md:text-4xl lg:text-5xl font-extrabold text-heading">
            ...
            {values.map((value) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-display font-bold text-sm lg:text-base text-heading mb-2">
                    {value.title}
                  </h3>
      ...
      <section className="section-padding dark-section-bg relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          ...
          <h2 className="font-display text-xl md:text-3xl lg:text-4xl font-extrabold text-white mb-4">
            Regulatory <span className="text-accent-gradient">Compliance</span>
          </h2>
          <p className="text-white/50 text-xs lg:text-sm mb-10">
          ...
          <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-6 mb-10 text-left">
            {[
              ...
              <div key={item} className="flex items-center gap-3 py-2.5">
                ...
                <span className="text-white/70 text-xs lg:text-sm">{item}</span>
              </div>
            ))}
          </div>
          <Link href="/contact">
